...
class ScanScreen(tk.ThemedTk):
    ...
    def __init__(self, parent, controller):
        ...
        # back button
        bb = ttk.Button(self, text="back to menu", command=lambda: controller.show_frame(MainMenu))
