...
class ScanScreen(ttk.Frame):
    ...
    def makemenu(self, controller):
        ...
        applymenu.add_checkbutton(label='gaussian blur', variable=gauss_applybool, command=lambda: self.traverse_to_menu('a'))
        applymenu.add_checkbutton(label='sobel', variable=sobel_applybool, command=lambda: self.traverse_to_menu('a'))
        applymenu.add_checkbutton(label='hysteresis', variable=hyst_applybool, command=lambda: self.traverse_to_menu('a'))
        applymenu.add_separator()
        applymenu.add_checkbutton(label='senne', variable=senne_applybool, command=lambda: self.traverse_to_menu('a'))
        ...
        showmenu.add_checkbutton(label='original image', variable=og_showbool, command=lambda: self.traverse_to_menu('s'))
        showmenu.add_separator()
        showmenu.add_checkbutton(label='grayscale', variable=gray_showbool, command=lambda: self.traverse_to_menu('s'))
        showmenu.add_checkbutton(label='gaussian blur', variable=gauss_showbool, command=lambda: self.traverse_to_menu('s'))
        showmenu.add_checkbutton(label='sobel', variable=sobel_showbool, command=lambda: self.traverse_to_menu('s'))
        showmenu.add_checkbutton(label='hysteresis', variable=hyst_showbool, command=lambda: self.traverse_to_menu('s'))
        showmenu.add_separator()
        showmenu.add_checkbutton(label='senne', variable=senne_showbool, command=lambda: self.traverse_to_menu('s'))
        showmenu.add_checkbutton(label='dbscan', variable=db_showbool, command=lambda: self.traverse_to_menu('s'))
        showmenu.add_separator()
        showmenu.add_checkbutton(label='boxes', variable=boxes_showbool, command=lambda: self.traverse_to_menu('s'))
